...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        # Run self-attention block on encoded information prior to decoding
        # We use single-headed attention in this case (num_heads=1)
        self.attn = nn.MultiheadAttention(embed_dim=8, num_heads=1)
    ...
    def forward(self, x, z):
        ...
        # Apply the self-attention block to the compressed encoding
        c, _ = self.attn(query=c, key=c, value=c, need_weights=True)
